    ...
    tabsetPanel(type = "tabs",
       ...
       for raw item data when I can.\n\n"),
                ...
                tabPanel("Attribution/citation", 
                         ...
                         h4("APA"),
                         p("I think the correct citation in APA 7 format is just (Evans, 2023) and the reference format is:\n\n"),
                         p("Evans, C. (2023, September 17). ",
                           em("Compute RCI from SD and reliability."),
                           "PSYCTC.org. Retrieved April 17, 2024, from ",
                           a("https://shiny.psyctc.org/apps/RCI1/",
                             href="https://shiny.psyctc.org/apps/RCI1/")),
                         p("Where the name of the app, i.e. 'Compute RCI from SD and reliability' should be in italics.",
                           "(Hard to force that here in HTML!)"),
                         h4("BPS"),
                         p("I am sure the correct citation in BPS format is again just (Evans, 2023) and I",
                           em("think"),
                           "the BPS reference format is:\n\n"),
                         p("Evans, C. (2023). Compute RCI from SD and reliability. PSYCTC.org.  Retrieved April 17, 2024, from ",
                           a("https://shiny.psyctc.org/apps/RCI1/",
                             href="https://shiny.psyctc.org/apps/RCI1/")),
