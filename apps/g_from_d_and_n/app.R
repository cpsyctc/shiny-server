...
ui <- fluidPage(
  ...
  mainPanel(
    ...
    p("This incredibly basic shiny app uses the function hedges_g() from the package",
      ...
      " which has now (26.viii.25) grown into a small monograph which explores a lot about ",
      tags$i("g")),
    tags$ul(
      tags$li("Demonstrating that ", 
              tags$i("d"),
              " overestimates population ",
              tags$i("d"),
              " and that ",
              tags$i("g"),
              " does correct for that."),
      tags$li("Exploring different ways of computing ",
              tags$i("g"),
              "."),
      tags$li("Showing that ",
              tags$i("g"),
              " is not robust to unequal sample sizes, heteroscedasticity or non-Gaussian distributions"),
      tags$li("Concluding that if you have raw data, bootstrapping ",
              tags$i("g"),
              " will probably be more robust than this parametric conversion from ",
              tags$i("d"),
              " to ",
              tags$i("g"))
    ),
    p("App created by Chris Evans",
      ...
      tags$br(" "),
      " App first created 24.xii.24, most recent update with more linkage to the Rblog post 26.viii.25."
      ),
    hr(),
